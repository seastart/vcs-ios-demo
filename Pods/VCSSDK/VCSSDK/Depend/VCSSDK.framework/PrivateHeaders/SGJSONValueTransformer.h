 ...
 */
extern BOOL isSGNull(id value);

/////////////////////////////////////////////////////////////////////////////////////////////

#pragma mark - SGJSONValueTransformer interface
/**
 ...
 * Just few examples of what can you add to SGJSONValueTransformer: hex colors in SGJSON to UIColor,
 * hex numbers in SGJSON to NSNumber model properties, base64 encoded strings in SGJSON to UIImage properties, and more.
 *
 * The class is invoked by SGJSONModel while transforming incoming
 * SGJSON types into your target class property classes, and vice versa.
 * One static copy is create and store in the SGJSONModel class scope.
 */
@interface SGJSONValueTransformer : NSObject
 ...
 */
- (NSArray *)SGJSONObjectFromNSSet:(NSSet *)set;
 ...
 * @return an array with the set's elements
 */
- (NSArray *)SGJSONObjectFromNSMutableSet:(NSMutableSet *)set;

#pragma mark - BOOL <-> number/string
/** @name Transforming SGJSON types */
/**
 ...
 */
- (NSNumber *)SGJSONObjectFromBOOL:(NSNumber *)number;
 ...
 * @return the resulting string
 */
- (NSString *)SGJSONObjectFromNSURL:(NSURL *)url;
 ...
 * @return the resulting string
 */
- (NSString *)SGJSONObjectFromNSTimeZone:(NSTimeZone *)timeZone;
...
//- (NSString *)SGJSONObjectFromNSDate:(NSDate *)date;
