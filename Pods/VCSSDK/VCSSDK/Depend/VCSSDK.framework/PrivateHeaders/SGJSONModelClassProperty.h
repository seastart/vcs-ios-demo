...
/**
 * **You do not need to instantiate this class yourself.** This class is used internally by SGJSONModel
 ...
 */
@interface SGJSONModelClassProperty : NSObject
...
@property (assign, nonatomic) BOOL isStandardSGJSONType;
