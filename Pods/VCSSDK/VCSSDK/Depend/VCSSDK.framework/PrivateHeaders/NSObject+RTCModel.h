 ...
 */
+ (nullable instancetype)rtc_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)rtc_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)rtc_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)rtc_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)rtc_modelToJSONObject;
 ...
 */
- (nullable NSData *)rtc_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)rtc_modelToJSONString;
 ...
 */
- (void)rtc_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)rtc_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)rtc_modelIsEqual:(id)model;
 ...
 */
+ (nullable NSArray *)rtc_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (RTCModel)
 ...
 */
+ (nullable NSDictionary *)rtc_modelDictionaryWithClass:(Class)cls json:(id)json;
...
/**
 ...
 There's no need to add '<RTCModel>' to your class header.
 */
@protocol RTCModel <NSObject>
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class RTCShadow, RTCBorder, RTCAttachment;
 
        @interface RTCAttributes
        @property NSString *name;
        ...
        @implementation RTCAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [RTCShadow class],
                     @"borders" : RTCBorder.class,
                     @"attachments" : @"RTCAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class RTCCircle, RTCRectangle, RTCLine;
 
        @implementation RTCShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [RTCCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [RTCRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [RTCLine class];
            } else {
                return [self class];
            }
        }
